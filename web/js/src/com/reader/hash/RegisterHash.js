...
com.reader.hash.RegisterHash = function (base, me, SettingsController, Home, EditFeed, NewsList, Article, HashChange){this.setMe=function(_me){me=_me;};this.setMe=function(_me){me=_me};
    'use strict';
    var lastState = {}; 
